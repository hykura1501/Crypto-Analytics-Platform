...
\input{target}             % Mục tiêu / tổng quan bài toán
\input{chapter_scaling}    % Quá trình scale-up kiến trúc hệ thống

% Các tình huống kỹ thuật cụ thể
\input{chapter_1}          % Tình huống 1 (WebSocket / Market)
\input{chapter_2}          % Tình huống 2 (Crawler / News)
\input{chapter_ai_prediction} % Tình huống AI Prediction / XAI
\input{chapter_3}          % Tình huống 3 (Security & Auth)
